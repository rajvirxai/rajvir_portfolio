  ...
  <footer class="footer">
    ...
    <div class="footer-content">
      ...
      <div class="footer-credits">
        <p>© {{ new Date().getFullYear() }} Rajvir Singh</p>
        <div v-if="showAttribution" class="footer-credits-built" style="opacity: 0.7; margin-top: 4px;">
          <p>
        ...
        <div class="footer-credits-music" style="opacity: 0.7;">
          <p>
            {{ t("music-produced-by") }}
          </p>
          <Clickable renderAs="div">
